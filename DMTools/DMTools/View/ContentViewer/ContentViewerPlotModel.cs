...
{
    class ContentViewerPlotModel : ContentViewerViewModel
    {
        ...
        public ContentViewerPlotModel(PlotModel model)
        { m_model = model; }
        ...
        public override FlowDocument GetDocument()
        {
            ...
            if (m_model.PlotType != "") AddHeading2(result, $"{m_model.PlotType}");
